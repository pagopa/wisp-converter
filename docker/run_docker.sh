...
keyvault=$(yq  -r '."microservice-chart".secretProvider.keyvault.name' ../helm/values-$ENV.yaml)
secret=$(yq  -r '."microservice-chart".secretProvider.envSecrets' ../helm/values-$ENV.yaml)
