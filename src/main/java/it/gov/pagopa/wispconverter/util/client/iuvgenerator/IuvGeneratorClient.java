...
public class IuvGeneratorClient extends it.gov.pagopa.iuvgeneratorclient.client.ApiClient {

    private final RestTemplate restTemplate;
    private final Integer readTimeout;
    private final Integer connectTimeout;

    public IuvGeneratorClient(Integer readTimeout, Integer connectTimeout) {
