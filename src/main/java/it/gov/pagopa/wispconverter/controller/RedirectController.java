...
public class RedirectController {
    ...
    @EndpointRETrace(status = WorkflowStatus.CONVERSION_PROCESSED, businessProcess = BP_REDIRECT, outcomeError = OutcomeEnum.CONVERSION_ERROR_SENDING_RT, reEnabled = true)
