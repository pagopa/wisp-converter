...
import it.gov.pagopa.wispconverter.service.RtRequestCosmosService;
...
public class RTConsumer extends SBConsumer {
    ...
    @Autowired
    private RtRequestCosmosService rtRequestCosmosService;
    ...
    public void processMessage(ServiceBusReceivedMessageContext context) {
        ...
        RTRequestEntity rtRequestEntity = rtRequestCosmosService.getRTRequestEntity(receiptId, rtInsertionDate);
    ...
    private void resendRTToCreditorInstitution(String receiptId, RTRequestEntity receipt, String compositedIdForReceipt, String idempotencyKey) {
        ...
        try {
            ...
            rtRequestCosmosService.deleteRTRequestEntity(receipt);
    ...
    private void reScheduleReceiptSend(RTRequestEntity receipt, String receiptId, String compositedIdForReceipt) {
        ...
        if (receipt.getRetry() < this.maxRetries - 1) {
            ...
            try {
                ...
                rtRequestCosmosService.saveRTRequestEntity(receipt);
